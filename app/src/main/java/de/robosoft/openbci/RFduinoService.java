...
public class RFduinoService extends Service {
    ...
    public final static String ACTION_CONNECTED =
            "de.robosoft.openbci.ACTION_CONNECTED";
    public final static String ACTION_DISCONNECTED =
            "de.robosoft.openbci.ACTION_DISCONNECTED";
    public final static String ACTION_DATA_AVAILABLE =
            "de.robosoft.openbci.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "de.robosoft.openbci.EXTRA_DATA";
    
    //RFDruino Characteristics
    public final static UUID UUID_SERVICE = BluetoothHelper.sixteenBitUuid(0x2220);
    /*
    from decompiled Flowtime EEG headband apk ..
    //public final static UUID UUID_SERVICE = new UUID(26392574038016L, -9223371485494954757L);
    //public final static UUID UUID_SERVICE = UUID.fromString("00002A00-0000-1000-8000-00805F9B34FB");
    UUID uUID = new UUID(-8157989233041780896L, -6937650605005804976L); //   BUTTONLESS_DFU_UUID
    new UUID(-8196551313441075360L, -6937650605005804976L); //  EXPERIMENTAL_BUTTONLESS_DFU_UUID
     = new UUID(280650646203341L, 1523193452336828707L);    // DEFAULT_DFU_SERVICE_UUID
    DEFAULT_DFU_CONTROL_POINT_UUID = new UUID(280654941170637L, 1523193452336828707L);
    DEFAULT_DFU_PACKET_UUID = new UUID(280659236137933L, 1523193452336828707L);
    UUID uUID = new UUID(280667826072525L, 1523193452336828707L);
    public static final UUID DEFAULT_DFU_SERVICE_UUID = new UUID(279658205548544L, -9223371485494954757L);
    DEFAULT_DFU_CONTROL_POINT_UUID = new UUID(-8157989241631715488L, -6937650605005804976L);
